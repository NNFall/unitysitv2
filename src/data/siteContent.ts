...
const yandexOrgProvenance: readonly Provenance[] = Object.freeze([
  {
    ...
    verified: true,
    note: 'Публичная карточка организации и отзывы; расписание может меняться в праздники.',
  },
])
  ...
  reviews: [
    {
      ...
      dateLabel: '5 марта',
      quote: 'Встретили по-доброму: успели сыграть в бильярд и пинг-понг, заглянуть в VIP-комнату и выбрать занятие под настроение.',
      attribution: 'summary',
      provenance: yandexOrgProvenance,
    },
    {
      ...
      quote: 'Понравились современные консоли, исправные геймпады и спокойная атмосфера — можно сосредоточиться на игре и не спешить.',
      attribution: 'summary',
      provenance: yandexOrgProvenance,
    },
    {
      id: 'review-maria',
      author: 'Мария К.',
      dateLabel: '28 марта 2025',
      quote: 'На первом этаже можно поговорить, на втором — поиграть. Особенно запомнились настолки, теннис и бильярд.',
      attribution: 'summary',
      provenance: yandexOrgProvenance,
    },
